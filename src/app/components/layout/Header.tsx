      ...
      <div className="bg-[#03484D] text-white">
        ...
        {/* ===== Top Bar ===== */}
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            {/* Wishlist */}
            <button className=" md:flex flex-col items-center p-2 hover:text-gray-100 rounded-lg relative">
            ...
            {/* Cart */}
            <button className="flex flex-col items-center p-2 hover:text-gray-100 rounded-lg relative">
            ...
            {/* Account */}
            <button className=" md:flex items-center p-2 hover:text-gray-100 rounded-lg">
          ...
          <div className="lg:hidden py-2 px-5 border-t bg-white">
            <div className="space-y-2">
              ...
              <div className="pt-4 border-t space-y-2">
                ...
                <Link href="/easy-installments" className="block py-2 text-gray-700 hover:text-primary-600">
                  Easy Monthly Installments
                </Link>
                <Link href="/shop-by-brand" className="block py-2 text-gray-700 hover:text-primary-600">
                  Shop by Brand
                </Link>
                <Link href="/become-vendor" className="block py-2 text-gray-700 hover:text-primary-600">
                  Become a Vendor
                </Link>
                      <div className="flex items-center space-x-4">
  <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">
        ...
        <div className="lg:hidden py-0 bg-white">
          <form onSubmit={handleSearch} className="flex relative">
            ...
            <div className="relative">
              ...
              >
                <FiGrid size={14} />
                <span className="" style={{fontSize:'10px'}}>{selectedCategory === 'all' ? 'All categories' : selectedCategory}</span>
